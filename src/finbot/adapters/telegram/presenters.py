...
Отправьте только сумму — бот спросит тип, категорию, счёт, дату и комментарий:
<pre>500
1 200,50</pre>

Либо сразу напишите полную запись:
<pre>1450 ресторан
+250000 зарплата
вчера 799 кино
...
Кнопка <b>➕ Добавить</b> открывает полный мастер.
Перед отправкой одной суммы нажимать её не нужно.
Сумму второй раз бот не спрашивает, а запись появляется только после итоговой проверки и сохранения.
